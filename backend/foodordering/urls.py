...
urlpatterns = [
    ...
    path('add-category/', add_category_api, name='add_category'),
    ...
    path('orders/by_order_number/<str:order_number>/',order_byorder_number,name='order_byorder_number'),
    path('orders/order_address/<str:order_number>/',get_order_address,name='get_order_address'),
    ...
    path('orders-delivered/',orders_delivered,name='orders_delivered'),
    ...
    path('edit-foods/<int:id>/',edit_food,name='edit_food'),
