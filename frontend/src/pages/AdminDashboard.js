   ...
   const adminUser = localStorage.getItem("adminUser");
      const navigate = useNavigate();
       ...
       const cardData = [
        ...
        {title: "This Month's Sales",key:'week_sales',color:'dark',icon:'fas fa-calendar-alt'},
        {title: "This Year's Sales",key:'year_sales',color:'success',icon:'fas fa-calendar'},
        {title: "Total Categories",key:'total_categories',color:'info',icon:'fas fa-list'},
  ...
  return (
     ...
     <AdminLayout>
      <div className='row g-3'>
        ...
        <div className='card text-white bg-dark  d-flex justify-content-between align-items-center'>
           <i className="fas fa-concierge-bell fa-2x text-danger mb-3"></i>
         <p className='text-white fw-bold text-center'>Laxmi Kitchen</p>
