  ...
  return (
    ...
    <div>
      <h3 className='text-center text-primary'>
        <i className='fas fa-list-alt me-1'></i>Manage food Item</h3>
        ...
        <h5 className='text-end text-muted'>
          ...
          <div className='mb-3 d-flex justify-content-between'>
            ...
            <CSVLink data={foods} className='btn btn-success' filename='food_list'>
               <i className='fas fa-file-csv me-1'></i>Export to CSV
            </CSVLink>
          </div>

          <table className='table table-bordered table-hover table-stripted'>
