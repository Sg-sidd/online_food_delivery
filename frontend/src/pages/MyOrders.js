...
const MyOrders = () => {
  ...
  return (
    ...
    <PublicLayout>
      ...
      <h3 className="text-center  text-primary mb-4"><FaBoxOpen className=" text-warning me-2" size={50}/>My Orders</h3>
      {orders.length === 0 ? (
       ...
       <div class="card mb-4 shadow-sm" key={index}>
          ...
          <div className="mt-3 mt-md-0">
            ...
            <FaMapMarkedAlt/>Track
             ...
             <Link to={`/order-details/${order.order_number}`} className="btn btn-outline-primary btnsm me-2">
