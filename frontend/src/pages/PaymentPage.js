    ...
    <div className="container py-5">
      ...
      <div className="card p-4 shadow-sm">
        <div className="mb-3">
          ...
          <textarea className="form-control border-primary-subtle" rows='3' required placeholder="Enter your full delivery address"  value={address} onChange={(e)=>setAddress(e.target.value)}></textarea>
        </div>
       ...
       {paymentMode === 'online' && (
        <div className="row"> 
         <div className="col-md-6">
          ...
          type='text'
          placeholder="3241 4563 3452 2354"
